...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-glint-600 to-glint-500 text-white shadow-lg shadow-glint-500/25 hover:shadow-glint-500/40 hover:scale-105",
        destructive:
        ...
        glass:
          "bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20",
      },
      size: {
